...
<head>
  ...
  <title>Thando Mpofu — Fullstack Software Developer</title>
  <meta name="description" content="README-style developer profile for Thando Mpofu — Fullstack Software Developer based in Victoria Falls, Zimbabwe." />

  <!-- Brand font (Montserrat). If you prefer no external calls, remove this link and the body will fall back to system fonts. -->
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;800&display=swap" rel="stylesheet">

  <style>
    :root{
      /* Brand palette from TMC Tech Solution */
      --blue: #1e90ff;
      --navy: #0b1b34;
      --black: #0e0f12;
      --white: #ffffff;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      background: radial-gradient(1200px 800px at 80% -10%, rgba(30,144,255,.15), transparent 60%),
                  radial-gradient(800px 600px at -10% 20%, rgba(110,231,255,.1), transparent 55%),
                  var(--bg);
      color: var(--white);
      line-height: 1.55;
      letter-spacing: .2px;
    ...
    a:hover{opacity:.9}
    .container{width:min(100%, var(--container)); margin-inline:auto; padding: 24px;}
